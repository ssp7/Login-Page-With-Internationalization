            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/superAdmin/superAdminShow?lang=hi_IN">Hindi</a></li>
                        <li><a href='/superAdmin/superAdminShow?lang=en'>English</a></li>
                        <li><a href='/superAdmin/superAdminShow?lang=es'>Spanish</a></li>
                        <li><a href='/superAdmin/superAdminShow?lang=it'>Italian</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div id="show-person" class="content scaffold-show" role="main">
            <div style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="nav" role="navigation">
                    <ul>
                        <li><g:link class="list" controller="superAdmin"  action="superAdminList"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
                    </ul>
                </div>
